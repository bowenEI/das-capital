...
\begin{table}[H]
    ...
    \begin{tabular}{lrlr}
        收入 & （单位：镑）& 支出 & （单位：镑） \\
        定期支付的银行家和商人的票据 & $533,596$ & 定期支付的票据 & $302,674$ \\
        见票即付的银行支票等 & $357,715$ & 伦敦各银行支票 & $663,672$ \\
        地方银行券 & $9,627$ & 英格兰银行券 & $22,743$ \\
        英格兰银行券 & $68,554$ & 金 & $9,427$ \\
        金 & $28,089$ & 银和铜 & $1,484$ \\
        银和铜 & $1,486$ & \enspace & \enspace \\
        邮汇 & 933 & \enspace & \enspace \\
        \hline
        总计 & $1,000,000$ & 总计 & $1,000,000$
    \end{tabular}
\end{table}
\rightline{（《银行法特别委员会的报告》1858 年 7 月第 71 页）}
